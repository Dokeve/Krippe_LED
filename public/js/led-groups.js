...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function readGroupLagerfeuerUI(prefix) {
    ...
    return {
      ...
      useSimple: !!document.getElementById(prefix + '-lagerfeuer-use-simple')?.checked,
    ...
    try {
      ...
      function populateGroupLagerfeuer(prefix, data) {
        ...
        document.getElementById(prefix + '-lagerfeuer-use-value-noise').checked = !!data.useValueNoise;
          const simpleEl = document.getElementById(prefix + '-lagerfeuer-use-simple');
          if (simpleEl) simpleEl.checked = !!data.useSimple;
